...
function love.update(dt)
    ...
    -- the '#' returns the number of elements in a table
    ...
    -- Checking bullet collision with zombies
    for i,z in ipairs(zombies) do
    ...
    -- Iterates through the zombie table, and if zombie.dead == true then deletes that zombie from the screen
    ...
    --  Doing the same thing for the bullets
    for i=#bullets, 1, -1 do
        local b = bullets[i]
        if b.dead == true then
            table.remove(bullets, i)
...
function spawnZombie()
    ...
    -- Defining from which side of the screen the zombie will spawn
